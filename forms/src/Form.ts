...
import { SelectInputText } from "./SelectField";
...
export class Form {
    ...
    constructor(id: string) {
        ...
        this.fields.push(new SelectInputText('Wybrany kierunek studiów', 'Wybrany kierunek studiów', 'Wybrany kierunek studiów', ['Informatyk', 'Ekonomista', 'DDDD']))
    ...
    edit(x: string): any {
        ...
        const retrievedObject = localStorage.getItem(x); // bierze go z lokal storedz i przypisuje do object
        let Surname =  document.getElementById(this.fields[0].name) as HTMLFormElement; // tworze zmeina surname każda zmiena ma inne id  wartosc surname jejsonuje
